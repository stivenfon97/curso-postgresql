...
SELECT first_name, last_name, followers FROM users WHERE following > 4600;
...
SELECT first_name, last_name, country, last_connection, COUNT(*)
FROM users
WHERE (country = 'Iceland') AND 
    (last_connection LIKE '112.%' OR
    last_connection LIKE '28.%' OR
    last_connection LIKE '188.%')
GROUP BY first_name, last_name, country, last_connection;
...
ORDER BY country ASC, first_name, last_name ASC;
