...
WHERE
 ...
 SELECT * FROM users WHERE name LIKE '%st_ven%';
 
 delete from users where name like '%st_ven%';
...
SELECT
	...
	SUBSTRING(name, 0, 5),
	POSITION(' ' in name),
	SUBSTRING(name, 0, POSITION(' ' IN name)) AS frist_name,
